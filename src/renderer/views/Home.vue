  ...
  <div id="landing">
    ...
    <div class="md-layout md-gutter">
      ...
      <div class="md-layout-item">
        ...
        >
          <i ref="bubble" slot="prefix"  class="el-input__icon el-icon-search bubble-wrapper"
          @click="jumpOver();searchWord()"
          ></i>
        </el-input>
      </div>
      <div class="md-layout-item md-size-15"></div>
    ...
    <vue-loading v-if="loading" type="bars" color="#B3C0D1" :size="{ width: '50px', height: '50px' }"></vue-loading>

    <div v-for="(books,index) in tmp" :key="index" style="padding:30px;" class="md-layout md-gutter md-alignment-center">
      <div v-for="book in books" :key="book.md5" class="md-layout-item md-medium-size-33 md-small-size-50 md-xsmall-size-100">
  ...
  name: 'Home',
    ...
    methods: {
      ...
      searchWord () {
        ...
        this.tmp = []
        this.$http
          .get('https://vue-aplayer-django.herokuapp.com/index/searchBook/'+this.input)
          .then(response => {
